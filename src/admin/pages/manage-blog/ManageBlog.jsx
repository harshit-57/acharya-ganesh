...
import PaginationTable from './components/BlogTable';
...
const ManageBlogs = () => {
    ...
    const fetchBlogs = async () => {
        try {
            ...
            if (searchQuery && searchQuery?.length >= 3) {
                response = await APIHelper.getBlogs({
                    page: currentPage,
                    pageSize: pageSize,
                    search: searchQuery,
    ...
    const exportData = async () => {
        ...
        try {
            const res = await APIHelper.getBlogs({
                page: 1,
                pageSize: totalCount,
            });
            ...
            PrintExcel(
                res?.data?.data,
                `BlogData-${moment(new Date()).format('YYYY-MM-DD')}.xlsx`
            );
        ...
        <Fragment>
            ...
            {showDeleteAlert && (
                <AlertDialog
                    ...
                    title="Delete Blog"
                    description="Are you want to sure delete the blog?"
