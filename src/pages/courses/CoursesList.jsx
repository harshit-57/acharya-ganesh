...
const CoursesList = () => {
    ...
    return (
        <PageContainer className={css.container}>
            ...
            <div
                style={{ backgroundImage: `url(${Images.default.ImgCourseBanner})` }}
            ...
            <div className={css.filter_container}>
                <div className={css.filter_item_wrapper}>
                    <div>
                        <img src={Images.default.ICSearchMd} alt={'Search icon'} />
                        <input
                            type={'text'}
                            value={searchQuery}
                ...
                >
                    ...
                    >
                        <img src={Images.default.ICFilter} alt={'Filter icon'} />
